...
public class FloatingActionButton extends ImageButton {
        ...
        if (attr != null) {
            try {
                mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal,
                    getColor(R.color.fab_normal));
                mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed,
                    getColor(R.color.fab_pressed));
    ...
    public void slideIn(boolean animate) {
        slide(true, animate, false);
    }

    public void slideOut(boolean animate) {
        slide(false, animate, false);
    }

    private void slide(final boolean visible, final boolean animate, boolean force) {
    ...
    public static class FabOnScrollListener extends ScrollDirectionDetector implements ScrollDirectionListener {
        ...
        public void onScrollUp() {
            mFloatingActionButton.slideOut();
        }
    }
}