 ...
 */
public class ListFragment extends Fragment implements SwipeRefreshable {
    ...
    public void setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener refreshListener) {
        if (mSwipeRefreshLayout != null) {
            mSwipeRefreshLayout.setListView(mList);
    ...
    protected ListView createListView(LayoutInflater inflater) {
        return (ListView) inflater.inflate(R.layout.list_view, null);
    }
    ...
    private void ensureList() {
        ...
        mList = createListView(getActivity().getLayoutInflater());
        ((ViewGroup) mListContainer).addView(mList, 1);
        if (mList == null) {
        ...
        if (mEmptyView != null) {
            ...
            mList.setEmptyView(mListContainer.findViewById(R.id.emptyContainer));
        }
